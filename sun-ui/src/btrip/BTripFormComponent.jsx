...
import CoWorkSelectComponent from "../cowork/CoWorkSelectComponent";
...
const BTripFormComponent = () => {
    ...
    const modalBody = modalTarget === 'destination' ? (
        <CoWorkSelectComponent onAddressSelect={handleCoWorkSelect} />
    ) : (
                                        ...
                                        <div style={{ display: "flex", alignItems: "center", marginTop: 10 }}>
                                            <div style={{ visibility: options.group1 === "option2" ? 'visible' : 'hidden', display: 'flex', alignItems: 'center', width: '100%' }}>
                                                <input
                                                    type="text"
                                                    readOnly
                                                    value={btripInfo.departureAddress.areaAddress +""+ btripInfo.departureAddress.townAddress}
